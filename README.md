...
The machine code written in program.txt and writes the assembly line by line in output.txt. This output can be copy pasted into Logisim ROM for execution
